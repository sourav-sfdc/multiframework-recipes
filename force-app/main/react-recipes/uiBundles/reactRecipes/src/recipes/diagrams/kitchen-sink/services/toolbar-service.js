...
// Swapped to local stub (see directed-graph-stub.js).
// Restore with: import { DirectedGraph } from '@joint/layout-directed-graph';
import { DirectedGraph } from './directed-graph-stub';
