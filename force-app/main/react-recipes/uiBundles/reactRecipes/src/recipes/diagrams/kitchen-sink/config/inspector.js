// ES imports — Vite bundles the referenced images and returns base-aware
// URLs at runtime. Plain 'assets/...' strings break on Salesforce.
import transparentIcon from '../assets/transparent-icon.svg';
import noColorIcon from '../assets/no-color-icon.svg';
import imageIcon1 from '../assets/image-icon1.svg';
import imageIcon2 from '../assets/image-icon2.svg';
import imageIcon3 from '../assets/image-icon3.svg';
import imageIcon4 from '../assets/image-icon4.svg';
import memberMale from '../assets/member-male.png';
import memberFemale from '../assets/member-female.png';

const BORDER_COLOR = '#374151';
const options = {
    colorPalette: [
        { content: 'transparent', icon: transparentIcon },
        { content: '#000000' },
        { content: '#1B1B1B' },
        { content: '#353535' },
        { content: '#626262' },
    ...
    colorPaletteReset: [
        { content: 'transparent', icon: noColorIcon },
        { content: '#000000' },
        { content: '#1B1B1B' },
        { content: '#353535' },
        { content: '#626262' },
    ...
    imageIcons: [
        { value: imageIcon1, content: `<img height="42px" src="${imageIcon1}"/>` },
        { value: imageIcon2, content: `<img height="80px" src="${imageIcon2}"/>` },
        { value: imageIcon3, content: `<img height="80px" src="${imageIcon3}"/>` },
        { value: imageIcon4, content: `<img height="80px" src="${imageIcon4}"/>` }
    ],
    imageGender: [
        { value: memberMale, content: `<img height="50px" src="${memberMale}" style="margin: 5px 0 0 2px;"/>` },
        { value: memberFemale, content: `<img height="50px" src="${memberFemale}" style="margin: 5px 0 0 2px;"/>` }
    ],
    arrowheadSize: [
