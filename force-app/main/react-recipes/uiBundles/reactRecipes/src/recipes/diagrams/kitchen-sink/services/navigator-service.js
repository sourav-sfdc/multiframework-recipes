...
// ES imports so Vite bundles these assets with base-aware URLs. Plain
// 'assets/navigator/...' strings break on Salesforce because the bundle is
// not served from the org root.
import fitToScreenIcon from '../assets/navigator/fit-to-screen.svg';
import minimapIcon from '../assets/navigator/minimap.svg';
import exitFullscreenIcon from '../assets/navigator/exit-fullscreen.svg';
import requestFullscreenIcon from '../assets/navigator/request-fullscreen.svg';
